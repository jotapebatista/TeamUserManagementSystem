...
namespace TeamUserManagementSystem.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public TeamsController(Context context, ILogger<TeamsController> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Teams != null ? 
                          ...
                          Problem("Entity set 'Context.Teams'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Context.Teams'  is null.");
            }
            var team = await _context.Teams.FindAsync(id);
            if (team != null)
            {
